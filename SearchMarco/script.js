...
$("#pallino").css({"width":"0vh","height":"0vh"});
  ...
  if($("#login").hasClass("in") && $("#randomizza").hasClass("random")){  //LOGGED IN e RANDOM//
    ...
    $("#row1b-1,#row1b-4,#row2b,#row4b,#row5b-1,#row5b-2,#row9b-3,#row9b-4,#row10b,#row11b").children(".row").children(".thumbnail").addClass("keyword");
    $("#row1b-2,#row1b-3,#row3b").children(".row").children(".thumbnail").addClass("searchrelated");
    $("#row5b-3,#row5b-4,#row6b,#row7b,#row8b,#row9b-1,#row9b-2").children(".row").children(".thumbnail").addClass("unrelated");
    ...
    $("#row1a-1,#row1a-2,#row2a-3,#row2a-4,#row3a-1,#row4a-3").children(".row").children(".thumbnail").addClass("keyword");
    $("#row1a-3,#row1a-4,#row2a-1,#row2a-2,#row3a-2,#row3a-3,#row3a-4,#row4a-1,#row4a-2,#row4a-4,#row5a,#row6a,#row7a,#row8a,#row9a,#row10a").children(".row").children(".thumbnail").addClass("searchrelated");
    $("#row1b-1,#row1b-4,#row2b,#row4b,#row5b,#row6b,#row7b,#row8b,#row9b,#row10b,#row11b").children(".row").children(".thumbnail").addClass("keyword");
    $("#row1b-2,#row1b-3,#row3b").children(".row").children(".thumbnail").addClass("searchrelated");
    $("#row1a-1").css("background-image","url('/assets/primevideo_thumbnails/1.jpg')"); //PRIMEVIDEO
    $("#row1a-2").css("background-image","url('/assets/primevideo_thumbnails/2.jpg')");
    $("#row1a-3").css("background-image","url('/assets/primevideo_thumbnails/3.jpg')");
