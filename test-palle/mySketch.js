...
let colorPattern = ['#F54F8E', '#0FF2C9', '#F2E96B', '#F2F2EB', '#2949BD',
    '#A75E8A', '#FBA3B2', '#C4DD89', '#EAA56F', '#F5DA62'
]
...
function setup() {
    ...
    for (let i = 0; i < boxNum; i++) {
        ...
        circles.push(new Circle(random(width), random(height), random(10, boxMaxSize), c));
    }
}
